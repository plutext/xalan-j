...
import org.docx4j.org.apache.xml.dtm.DTMException;
...
import org.docx4j.org.apache.xml.dtm.ref.dom2dtm.DOM2DTM;
import org.docx4j.org.apache.xml.dtm.ref.sax2dtm.SAX2DTM;
import org.docx4j.org.apache.xml.dtm.ref.sax2dtm.SAX2RTFDTM;
import org.docx4j.org.apache.xml.res.XMLErrorResources;
...
import org.docx4j.org.apache.xml.utils.XMLReaderManager;
import org.docx4j.org.apache.xml.utils.XMLStringFactory;
...
public class DTMManagerDefault extends DTMManager
{
        ...
        try {
          ...
          **************************************************************/
          ...
          boolean haveXercesParser =
                     ...
                     && (reader.getClass()
                               .getName()
                               .equals("org.docx4j.org.apache.xerces.parsers.SAXParser") );
          ...
          if (m_incremental && incremental
            ...
            if (haveXercesParser) {
              ...
              try {
                coParser =(IncrementalSAXSource)
                  Class.forName("org.docx4j.org.apache.xml.dtm.ref.IncrementalSAXSource_Xerces").newInstance();  
              }  catch( Exception ex ) {
                ex.printStackTrace();
                coParser=null;
              }
            ...
            if (JKESS_XNI_EXPERIMENT && m_incremental &&
                ...
                org.docx4j.org.apache.xerces.xni.parser.XMLPullParserConfiguration xpc=
  ...
  synchronized public int getDTMHandleFromNode(org.w3c.dom.Node node)
  {
    ...
    if (node instanceof org.docx4j.org.apache.xml.dtm.ref.DTMNodeProxy)
      return ((org.docx4j.org.apache.xml.dtm.ref.DTMNodeProxy) node).getDTMNodeNumber();
    ...
    else
    {
      ...
      if(node instanceof org.docx4j.org.apache.xml.dtm.ref.dom2dtm.DOM2DTMdefaultNamespaceDeclarationNode)
      {
  ...
  synchronized public boolean release(DTM dtm, boolean shouldHardDelete)
  {
    ...
    if (dtm instanceof SAX2DTM)
    {
      ((SAX2DTM) dtm).clearCoRoutine();
		...
		if(dtm instanceof DTMDefaultBase)
		{
			org.docx4j.org.apache.xml.utils.SuballocatedIntVector ids=((DTMDefaultBase)dtm).getDTMIDs();
                                       ...
                                       boolean entityReferenceExpansion)
  {
    ...
    /** @todo: implement this org.docx4j.org.apache.xml.dtm.DTMManager abstract method */
    return null;
  }
