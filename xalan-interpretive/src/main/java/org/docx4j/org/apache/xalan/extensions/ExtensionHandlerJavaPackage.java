...
import org.docx4j.org.apache.xalan.trace.ExtensionEvent;
          ...
          if (methods[i].getName().equals(element))
          {
            ...
            if ( (paramTypes.length == 2)
              && paramTypes[0].isAssignableFrom(
                                     org.docx4j.org.apache.xalan.extensions.XSLProcessorContext.class)
              && paramTypes[1].isAssignableFrom(
                                       org.docx4j.org.apache.xalan.templates.ElemExtensionCall.class) )
            {
              return true;
            }
          }
