...
import org.docx4j.org.apache.xalan.transformer.NodeSorter;
...
public class ElemForEach extends ElemTemplateElement implements ExpressionOwner
{
          ...
          throws TransformerException
  {
    ...
    if (transformer.getDebug())
    {
         ...
         *            new org.docx4j.org.apache.xpath.objects.XNodeSet(sourceNodes));
         */ 
        ...
        org.docx4j.org.apache.xpath.objects.XObject xObject = expr.execute(xctxt);
