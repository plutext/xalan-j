...
import org.docx4j.org.apache.xalan.transformer.TrAXFilter;
...
import org.docx4j.org.apache.xml.utils.StopParseException;
import org.docx4j.org.apache.xml.utils.StylesheetPIHandler;
...
public class TransformerFactoryImpl extends SAXTransformerFactory
{
   ...
   * <code>org.docx4j.org.apache.xpath.functions.FuncSystemProperty.XSLT_PROPERTIES</code>
   */
          ...
          throws TransformerConfigurationException
  {
    ...
    try
    {
      ...
      TreeWalker walker = new TreeWalker(builder,
                                         new org.docx4j.org.apache.xml.utils.DOM2Helper(),
                                         builder.getSystemId());
            ...
            throws TransformerConfigurationException
  {
    ...
    try
    {
      if (null != node)
      {
        TreeWalker walker = new TreeWalker(handler, new org.docx4j.org.apache.xml.utils.DOM2Helper(), baseID);
...
//  private static Templates m_identityTemplate = null;
  ...
  /** The error listener.   */
  private ErrorListener m_errorListener = new org.docx4j.org.apache.xml.utils.DefaultErrorHandler(false);
