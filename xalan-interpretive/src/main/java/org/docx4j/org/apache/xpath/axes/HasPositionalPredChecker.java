...
import org.docx4j.org.apache.xpath.functions.FuncLast;
import org.docx4j.org.apache.xpath.functions.FuncPosition;
...
import org.docx4j.org.apache.xpath.operations.Quo;
  ...
  public boolean visitPredicate(ExpressionOwner owner, Expression pred)
  {
    ...
    if(m_predDepth == 1)
    {
      if((pred instanceof Variable) || 
         ...
         (pred instanceof org.docx4j.org.apache.xpath.operations.Number) ||
