...
import org.docx4j.org.apache.xpath.SourceTreeManager;
import org.docx4j.org.apache.xpath.XPathContext;
import org.docx4j.org.apache.xpath.functions.Function2Args;
...
//          base = xctxt.getSourceTreeManager().findURIFromDoc(baseDoc);
          ...
          throws javax.xml.transform.TransformerException
  {
    ...
    catch (Throwable throwable)
    {
      ...
      {
        throw new org.docx4j.org.apache.xml.utils.WrappedRuntimeException(
          (Exception) throwable);
      }
...

        {
          ...
          while (null != e)
          {
            ...
            if (e instanceof TransformerException)
            {
              ...
              if (e instanceof org.docx4j.org.apache.xml.utils.WrappedRuntimeException)
                e = ((org.docx4j.org.apache.xml.utils.WrappedRuntimeException) e).getException();
            }
            else
              e = null;
          }
