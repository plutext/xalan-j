...
implements IncrementalSAXSource, ContentHandler, DTDHandler, LexicalHandler, ErrorHandler, Runnable
{
  ...
  public void startParse(InputSource source) throws SAXException
  {
    ...
    // org.docx4j.org.apache.xalan.transformer.TransformerImpl.runTransformThread(this);
  ...
  public static void main(String args[])
  {
    ...
    org.xml.sax.XMLReader theSAXParser=
      new org.docx4j.org.apache.xerces.parsers.SAXParser();
    ...
    for(int arg=0;arg<args.length;++arg)
    {
      ...
      org.docx4j.org.apache.xml.serialize.XMLSerializer trace;
      trace=new org.docx4j.org.apache.xml.serialize.XMLSerializer(System.out,null);
