...
public class FilterExprIteratorSimple extends LocPathIterator
{
  ...
  public static XNodeSet executeFilterExpr(int context, XPathContext xctxt, 
  												...
  												int stackFrame,
  												Expression expr )
    throws org.docx4j.org.apache.xml.utils.WrappedRuntimeException
  {
    ...
    try
    {
      ...
      if (isTopLevel)
      {
        ...
        result = (org.docx4j.org.apache.xpath.objects.XNodeSet) expr.execute(xctxt);
    ...
    catch (javax.xml.transform.TransformerException se)
    {
      ...
      // TODO: Fix...
      throw new org.docx4j.org.apache.xml.utils.WrappedRuntimeException(se);
    }
    finally
    {
