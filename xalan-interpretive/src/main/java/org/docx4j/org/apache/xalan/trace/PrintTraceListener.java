 ...
 *
 * @see org.docx4j.org.apache.xalan.trace.TracerEvent
 * @xsl.usage advanced
 */
...
public void selected(SelectionEvent ev)
    ...
    if (m_traceSelection) {
        ...
        if (ev.m_selection.getType() == ev.m_selection.CLASS_NODESET) {
            ...
            org.docx4j.org.apache.xml.dtm.DTMIterator nl = ev.m_selection.iter();
            ...
            org.docx4j.org.apache.xml.dtm.DTMIterator clone = null;
            // End of block
