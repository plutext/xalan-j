...
public class VariableStack implements Cloneable
{
  ...
  public XObject getVariableOrParam(
          XPathContext xctxt, org.docx4j.org.apache.xml.utils.QName qname)
            throws javax.xml.transform.TransformerException
  {

    org.docx4j.org.apache.xml.utils.PrefixResolver prefixResolver =
    ...
    if (prefixResolver instanceof org.docx4j.org.apache.xalan.templates.ElemTemplateElement)
    {
      
      org.docx4j.org.apache.xalan.templates.ElemVariable vvar;

      org.docx4j.org.apache.xalan.templates.ElemTemplateElement prev =
        (org.docx4j.org.apache.xalan.templates.ElemTemplateElement) prefixResolver;

      if (!(prev instanceof org.docx4j.org.apache.xalan.templates.Stylesheet))
      {
        while ( !(prev.getParentNode() instanceof org.docx4j.org.apache.xalan.templates.Stylesheet) )
        {
