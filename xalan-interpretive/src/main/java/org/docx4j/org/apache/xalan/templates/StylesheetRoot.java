...
import org.docx4j.org.apache.xalan.extensions.ExtensionNamespacesManager;
import org.docx4j.org.apache.xalan.processor.XSLTSchema;
...
//    if(true && org.docx4j.org.apache.xalan.processor.TransformerFactoryImpl.m_optimize)
//    {
...
//    }
  ...
  private void QuickSort2(Vector v, int lo0, int hi0)
    ...
    private String m_extensionHandlerClass = 
        "org.docx4j.org.apache.xalan.extensions.ExtensionHandlerExsltFunction";
    ...
    class ComposeState
    {
      ...
      public int getQNameID(QName qname)
      {
        ...
        return m_ent.getExpandedTypeID(qname.getNamespace(), 
                                       ...
                                       // purposes. 
                                       org.docx4j.org.apache.xml.dtm.DTM.ELEMENT_NODE);
      }
       ...
       */
      int addVariableName(final org.docx4j.org.apache.xml.utils.QName qname)
      {
