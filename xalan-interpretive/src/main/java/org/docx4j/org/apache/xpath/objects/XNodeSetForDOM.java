...
public class XNodeSetForDOM extends XNodeSet
{
  ...
  public XNodeSetForDOM(NodeList nodeList, XPathContext xctxt)
  {
    ...
    // m_obj=new org.docx4j.org.apache.xpath.NodeSetDTM(nodeList, xctxt);
    org.docx4j.org.apache.xpath.NodeSetDTM nsdtm=new org.docx4j.org.apache.xpath.NodeSetDTM(nodeList, xctxt);
  ...
  public XNodeSetForDOM(NodeIterator nodeIter, XPathContext xctxt)
  {
    ...
    // folks to request length through an accessor, so we can defer this
    // retrieval... but that requires an API change.
    // m_obj = new org.docx4j.org.apache.xpath.NodeSetDTM(nodeIter, xctxt);
    org.docx4j.org.apache.xpath.NodeSetDTM nsdtm=new org.docx4j.org.apache.xpath.NodeSetDTM(nodeIter, xctxt);
    m_last=nsdtm.getLength();
    setObject(nsdtm);   
  }
