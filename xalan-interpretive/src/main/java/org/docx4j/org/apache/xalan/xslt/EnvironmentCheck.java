 ...
 * <code>
 * java org.docx4j.org.apache.xalan.xslt.EnvironmentCheck [-out outFile]
 * </code></p>
 * 
...
//              || "xalan.jar".equalsIgnoreCase(jarName))
  ...
  protected void checkProcessorVersion(Hashtable h)
  {
    ...
    try
    {
      final String XALAN1_VERSION_CLASS =
        "org.docx4j.org.apache.xalan.xslt.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_VERSION_CLASS =
        "org.docx4j.org.apache.xalan.processor.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_2_VERSION_CLASS =
        "org.docx4j.org.apache.xalan.Version";
  ...
  protected void checkParserVersion(Hashtable h)
  {
    ...
    try
    {
      final String XERCES1_VERSION_CLASS = "org.docx4j.org.apache.xerces.framework.Version";
    ...
    try
    {
      final String XERCES2_VERSION_CLASS = "org.docx4j.org.apache.xerces.impl.Version";
    ...
    try
    {
      final String CRIMSON_CLASS = "org.docx4j.org.apache.crimson.parser.Parser2";
  ...
  protected void checkAntVersion(Hashtable h)
  {
    ...
    try
    {
      final String ANT_VERSION_CLASS = "org.docx4j.org.apache.tools.ant.Main";
