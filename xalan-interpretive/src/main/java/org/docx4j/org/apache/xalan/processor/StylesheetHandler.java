...
import org.docx4j.org.apache.xalan.extensions.ExpressionVisitor;
...
import org.docx4j.org.apache.xml.utils.NamespaceSupport2;
import org.docx4j.org.apache.xml.utils.NodeConsumer;
import org.docx4j.org.apache.xml.utils.PrefixResolver;
import org.docx4j.org.apache.xml.utils.SAXSourceLocator;
import org.docx4j.org.apache.xml.utils.XMLCharacterRecognizer;
import org.docx4j.org.apache.xpath.XPath;
import org.docx4j.org.apache.xpath.compiler.FunctionTable;
        ...
        implements TemplatesHandler, PrefixResolver, NodeConsumer
{
  ...
  {
    Class func = org.docx4j.org.apache.xalan.templates.FuncDocument.class;
    m_funcTable.installFunction("document", func);

    // func = new org.docx4j.org.apache.xalan.templates.FuncKey();
    // FunctionTable.installFunction("key", func);
    func = org.docx4j.org.apache.xalan.templates.FuncFormatNumb.class;
   ...
   * to support the {@link org.docx4j.org.apache.xml.utils.PrefixResolver} interface,
    ...
    try
    {
      ...
      if(
	   ...
	   ("doc-cache-off".equals(localName) &&
	    ns.equals("org.docx4j.org.apache.xalan.xslt.extensions.Redirect") )
	 )
      {
   ...
   *
   * @param msg An key into the {@link org.docx4j.org.apache.xalan.res.XSLTErrorResources}
   ...
   * exception.
   *
   * @param msg A key into the {@link org.docx4j.org.apache.xalan.res.XSLTErrorResources}
   * table, that is one of the WG_ prefixed definitions.
   * @param args An array of arguments for the given warning.
   * @param e An error which the SAXException should wrap.
   *
   ...
   *  from a DOM.
   *  @see org.docx4j.org.apache.xml.utils.NodeConsumer
   */
