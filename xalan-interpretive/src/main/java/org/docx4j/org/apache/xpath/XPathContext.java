...
import org.docx4j.org.apache.xml.utils.IntStack;
...
import org.docx4j.org.apache.xpath.objects.DTMXRTreeFrag;
...
public class XPathContext extends DTMManager // implements ExpressionContext
{
 ...
 /**
  ...
  protected DTMManager m_dtmManager = DTMManager.newInstance(
                   org.docx4j.org.apache.xpath.objects.XMLStringFactoryImpl.getFactory());
...
//
  ...
  public DTMIterator createDTMIterator(int node)
  {
    ...
    DTMIterator iter = new org.docx4j.org.apache.xpath.axes.OneStepIteratorForward(Axis.SELF);
  ...
  public final ErrorListener getErrorListener()
  {
    ...
    if (null == retval)
    {
      if (null == m_defaultErrorListener) 
        m_defaultErrorListener = new org.docx4j.org.apache.xml.utils.DefaultErrorHandler();
...
//  private NodeVector m_currentNodes = new NodeVector();
  ...
  public org.docx4j.org.apache.xpath.axes.SubContextList getCurrentNodeList()
  {
    return m_axesIteratorStack.isEmpty()
  ...
  public class XPathExpressionContext implements ExpressionContext
  {
    ...
    {
      return new org.docx4j.org.apache.xml.dtm.ref.DTMNodeIterator(getContextNodeList());
    }
    ...
    public final XObject getVariableOrParam(org.docx4j.org.apache.xml.utils.QName qname)
              throws javax.xml.transform.TransformerException
    {
